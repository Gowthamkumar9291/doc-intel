...
function parseKeyPoints(text) {
  ...
  const callClaude = async (messages, system) => {
    const resp = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${process.env.REACT_APP_GEMINI_API_KEY}`, {
      method: "POST",
